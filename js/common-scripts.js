(function ($) {
    $(function () {
            ...
            if ($('.home-page').length) {
                ...
                tl1.to('.brilliance-means-title figure', {
                    width: "200px",
                    marginTop: "30px"
                }, '>')

                var brillianceItem1 = $('.brilliance-means-thumb').eq(0)
                var brillianceItem2 = $('.brilliance-means-thumb').eq(1)
                var brilliancTitleP = $('.brilliance-means-title p')

                let tl2 = gsap.timeline({
                    scrollTrigger: {
                        trigger: ".brilliance-means-wrap",
                        start: "0%",
                        end: "70%",
                        scrub: true,
                        markers: true,
                ...
                tl2.to(brilliancTitleP, {
                    maxWidth: "47.451%",
                }, '>')
                tl2.to(brillianceItem1, {
                    width: "44.445%",
                }, '<')
                tl2.to(brillianceItem2, {
                    width: "47.719%",
                }, '<')
            ...
            if ($('.about-page').length) {
                ...
                var brillianceItem = $('.right-opportunity-wrap.we-are-info .brilliance-means-title figure')
                var brillianceTitleP = $('.about-page .right-opportunity-wrap .brilliance-means-title h3')
                ...
                //            tl2.to(brillianceTitleP, {
                //                width: "32.2%",
                //            }, '>')
                tl2.to(brillianceItem, {
                    width: "32.2%",
                }, '<')
            ...
            if($('.our-culture-wrap').length){
              
            function initParallax() {

                $('.our-culture-wrap').each(function (slide, i) {
                    let imageWrappers = $(this).find('.our-culture-thumb figure');
                    let imageWrappers2 = $(this).not('.our-culture-wrap').find('.our-culture-thumb figure');
                    ...
                    let oddColumns = getGrid(imageWrappers2).rows("odd");

                    gsap.fromTo(oddColumns, {
                        height: "336px"
                    }, {
                        height: "286px",
                        scrollTrigger: {
